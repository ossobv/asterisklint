...
RDWR_FUNCTION_LIST = (
    ...
    'CONNECTEDLINE', 'ENV', 'GLOBAL', 'GROUP', 'HASH',
    'MASTER_CHANNEL', 'REDIRECTING', 'SET', 'SHARED',
    # )
    #
    # RDONLY_FUNCTION_LIST = (
    'CHANNELS', 'CSV_QUOTE', 'CURL', 'CURLOPT', 'CUT', 'DEC',
    ...
    'LEN', 'LISTFILTER', 'MATH', 'PASSTHRU', 'POP', 'QUOTE', 'RAND',
    'REGEX', 'REPLACE', 'SHELL', 'SHIFT', 'SORT', 'STAT', 'STRFTIME',
